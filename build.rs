...
fn generate_bindings() {
    let mut builder = bindgen::Builder::default()
        ...
        .allowlist_type("nvcompBatchedZstdOpts_t")
        .allowlist_type("nvcompBatchedLZ4Opts_t")
        ...
        .allowlist_function("nvcompBatchedZstdCompressGetTempSize")
        ...
        .allowlist_function("nvcompBatchedLZ4CompressGetTempSize")
